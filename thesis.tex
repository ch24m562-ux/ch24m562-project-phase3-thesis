...
\begin{document}
  ...
  \begin{FrontMatter}
    ...
    %\printNotation
    %\input{1-frontmatter/front-figures-tables}
  \end{FrontMatter}
  ...
  \begin{MainMatter}
    ...
    \input{2-mainmatter/chapters/chap-problem-formulation}
    \input{2-mainmatter/chapters/chap-methodology}    
    \input{2-mainmatter/chapters/chap-datasets-setup}
    \input{2-mainmatter/chapters/chap-experimental-execution}   
    \input{2-mainmatter/chapters/chap-results}
    \input{2-mainmatter/chapters/chap-conclusion}

    \appendix
    \chapter{Thesis Execution Timeline}
    \input{2-mainmatter/appendices/appn-gantt}
    \chapter{Public Data Sources and Reference Parameters}
    \input{2-mainmatter/appendices/appn-data-sources}
    \chapter{Per-Site Enhanced Stress Analyses}
    \label{app:site_profiles}
    \input{2-mainmatter/appendices/appendix_site_profiles}
  \end{MainMatter}
