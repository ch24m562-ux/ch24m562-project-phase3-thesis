% filename: chap-experimental-execution-v2.tex
% Phase 3 rewrite: numbers verified directly against results/phase3/master_summary.csv
% and src/config/hparams.yaml, not carried over from the Phase 2 draft.
% Compressed per review: implementation log detail moved to tables; only
% one figure retained (execution pipeline); prose trimmed throughout.
...
compared, which is why it is used in place of the unpaired Welch's
$t$-test with $n=3$ seeds used in an earlier, smaller-scale pilot phase
of this project.
