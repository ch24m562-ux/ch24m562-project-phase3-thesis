...
evidence actually supports, how the scenario-dependent results
should be interpreted rather than the uniformly positive result originally
...
with receding-horizon optimisation while retaining the same calibrated
...
required parameters or forecast inputs. \textbf{Carbon and multi-objective
