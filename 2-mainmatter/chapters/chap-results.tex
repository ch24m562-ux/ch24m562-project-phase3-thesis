...
left to right: \textbf{B0} (threshold dispatch, fixed-interval
ordering), \textbf{B1} (threshold dispatch, calibrated $(s,S)$
...
\textbf{Evidence.} A5 is trained identically to RLInv but with
inventory and pending-delivery state removed from its observation
space. RLInv achieves numerically lower mean EENS than A5 in every
...
and pending-delivery status) vs.\ A5 (identical, these two observations
