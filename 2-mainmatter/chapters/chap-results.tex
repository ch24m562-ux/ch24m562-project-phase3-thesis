...
\textbf{Interpretation.} The ablation results are consistent with an
architecture-dependent benefit from masking under stressed logistics
when replenishment is externally managed (the A6-vs-TrackB comparison).
However, the A6--TrackB comparison also differs in observation design,
so the resulting gap should not be attributed to masking alone; the
cleaner masking comparison is RLInv vs.\ A7, which found no significant
mean-EENS effect. This is also
not a
...
defensible claim is that masking is associated with a substantial part of
the RLInv-TrackB gap under Monsoon/Extreme, not all of it, and that this
association is confounded with the observation-design difference between
A6 and TrackB. Separately,
